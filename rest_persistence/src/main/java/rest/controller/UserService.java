...
public class UserService {
	...
	@Path("/search")
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public User getUserByName(@QueryParam("name") String name, @QueryParam("local") String local, @QueryParam("promotor") String promotor, @QueryParam("data") String data) {
		return UserDAO.getUserByUsername(name, local, promotor, data);
	}
	...
	public User addUser(@FormDataParam("image") InputStream uploadedInputStream,
			@FormDataParam("name") String name, @FormDataParam("local") String local, @FormDataParam("promotor") String promotor, @FormDataParam("data") String data) {

		return UserDAO.addUser(name, local, promotor, data);
	}
	...
	public User updateUser(@PathParam("id") int id, @FormDataParam("image") InputStream uploadedInputStream,
		...
		if(contentDispositionHeader.getFileName() == null) {
			return UserDAO.updateUser(id, name, local, null);	
		} else {
			return UserDAO.updateUser(id, name, local, uploadedInputStream);
		}
	}
